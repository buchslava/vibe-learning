...
| 2 | [Toolchain and types](chapters/02_toolchain_and_types.md) | `chapters/02_toolchain_and_types.md` |
| 3 | [Ownership and borrowing](chapters/03_ownership_borrowing.md) | `chapters/03_ownership_borrowing.md` |
...
## Part III — Automation capstone

| Ch | Title | File |
|----|-------|------|
| 15 | [I/O, processes, and bits](chapters/15_io_processes_bits.md) | `chapters/15_io_processes_bits.md` |
| 16 | [Hardware and automation lab](chapters/16_hardware_automation_lab.md) | `chapters/16_hardware_automation_lab.md` |

## Appendices

| Doc | Purpose |
|-----|---------|
| [AI Prompt Index](appendix/AI_PROMPT_INDEX.md) | **101** Afterparty prompts (**P001–P101**) |
