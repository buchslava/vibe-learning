...
- Preface + chapters 1–11 (four parts)
- Appendices: Playground Guide, Trust & Use
...
From the book root (`rust-from-the-scratch/`):
...
Re-run `build.py` whenever chapter markdown changes. The merged source is written to `kindle/build/Rust-from-the-Scratch-Kindle.md` for debugging.
