#!/usr/bin/env python3
"""Build a single Kindle-friendly PDF from rust-from-the-scratch markdown sources."""
...
DIST = ROOT / "dist"
BUILD = KINDLE / "build"
OUTPUT = DIST / "Rust-from-the-Scratch-Kindle.pdf"
...
PARTS: list[tuple[str, list[Path]]] = [
    (
        ...
        [
            ...
            ROOT / "chapters/01_first_words.md",
            ROOT / "chapters/02_patterns_on_the_wall.md",
        ],
    ),
    (
        "Building Blocks",
        [
            ROOT / "chapters/03_crossroads.md",
            ROOT / "chapters/04_the_backpack.md",
            ROOT / "chapters/05_recipes.md",
            ROOT / "chapters/06_character_sheet.md",
        ],
    ),
    (
        "Game Novels",
        [
            ROOT / "chapters/07_compass_and_doors.md",
            ROOT / "chapters/08_guess_the_secret.md",
            ROOT / "chapters/09_tic_tac_toe_arena.md",
            ROOT / "chapters/10_snake_trail.md",
        ],
    ),
    (
        "Your Machine",
        [ROOT / "chapters/11_live_on_your_machine.md"],
    ),
]

APPENDICES: list[Path] = [
    ROOT / "appendix/PLAYGROUND_GUIDE.md",
    ROOT / "appendix/TRUST_AND_USE.md",
]
...
def assemble_book() -> Path:
    ...
    book = BUILD / "Rust-from-the-Scratch-Kindle.md"
