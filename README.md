...
Open **[Rust Core → Preface](rust-core/chapters/preface.md)**, then **[README](rust-core/README.md)** and **[CONTENTS.md](rust-core/CONTENTS.md)**.

Each chapter includes playground examples and **Afterparty** prompts for AI-assisted practice — see [AI Prompt Index](rust-core/appendix/AI_PROMPT_INDEX.md).
